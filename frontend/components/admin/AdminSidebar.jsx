...
const adminGroups = [
  ...
  { title: 'Finance', items: ['/admin/deposits', '/admin/nowpayments', '/admin/withdrawals', '/admin/p2p', '/admin/wallets', '/admin/income', '/admin/wallet', '/admin/settings/deposit-wallet'] },
