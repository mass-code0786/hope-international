...
export function StatCard({ title, value, subtitle, right, className = '', emphasis = 'default', compact = false, uppercaseTitle = true }) {
  ...
  const titleToneClass = uppercaseTitle ? 'uppercase tracking-[0.22em]' : 'tracking-[-0.01em]';
    ...
    >
      ...
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          <p className={`${titleToneClass} text-muted ${titleClass}`}>{title}</p>
