...
export default function AuctionDetailPage() {
  ...
  return (
    <div className="-mx-4 bg-[#f8fafc] px-3 pb-8 pt-0 sm:mx-0 sm:rounded-2xl sm:border sm:border-slate-200 sm:px-4 sm:py-4 sm:pb-6">
      <div className="space-y-4">
        ...
        {isLive ? (
          <section className="rounded-[28px] border border-slate-200 bg-white p-3 shadow-[0_14px_32px_rgba(15,23,42,0.08)]">
          ...
          <section className="rounded-[28px] border border-slate-200 bg-white px-4 py-3 text-center text-sm text-slate-600 shadow-[0_14px_32px_rgba(15,23,42,0.08)]">
