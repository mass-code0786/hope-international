...
export default function WalletPage() {
  ...
  return (
    <div className="space-y-3">
      <SectionHeader title="Wallet Overview" subtitle="Cash balance, BTCT rewards, wallet binding, and recent finance activity" />
      ...
      <div className="grid grid-cols-2 gap-2.5 md:grid-cols-3">
        ...
        <StatCard compact title="BTCT Balance" value={`${number(wallet.btct_balance || 0)} BTCT`} subtitle={`Fixed at ${currency(data.btctPrice || 0.1)} / BTCT`} right={<Coins size={18} className="text-accent" />} />
      ...
      <div className="rounded-xl border border-slate-200 bg-white">
        ...
        {!btctTransactions.length ? (
          <div className="p-3"><EmptyState title="No BTCT rewards yet" description="Auction loss compensation records will appear here." /></div>
        ) : (
          <div className="divide-y divide-slate-100">
